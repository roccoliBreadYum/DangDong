  ...
  <div class="container">
    <div id="header" class="mb-3">
      <div class="d-flex align-items-center justify-content-center">
        <button @click="decreaseDate" class="btn btn-outline-primary me-2">
          &#9664;
        </button>
        <div id="calendar">
          <input
        ...
        <button @click="increaseDate" class="btn btn-outline-primary ms-2">
          &#9654;
        </button>
      </div>
    </div>
    <div id="body" class="row">
      <div
        v-for="teacher in store.teacherList"
        :key="teacher.teacherId"
        class="col-md-6 mb-4"
      >
        <div class="card shadow-sm">
          <div class="card-header">{{ teacher.name }} 강사</div>
          <div class="card-body">
            <div
              v-for="lesson in store.lessonList"
              :key="lesson.lessonId"
              class="mb-2"
            >
              <div v-if="teacher.teacherId === lesson.teacherId">
                <button
                  @click="movePayHow(lesson.lessonId)"
                  :disabled="lesson.userCnt === lesson.capacity"
                  :class="{
                    'btn-enabled': lesson.userCnt !== lesson.capacity,
