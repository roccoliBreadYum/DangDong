<template>
    <div id="background">
        <div class="container my-5 p-5 bg-white rounded-4 shadow">
            ...
            <form @submit.prevent="registStore">
            <div id="regist-header" class="mb-4">
                <div id="name" class="mb-3">
                <label for="storeName" class="form-label">가게 명</label>
                <input type="text" id="storeName" class="form-control" placeholder="최대 10자" v-model="storeObj.storeName" required>
                </div>
                <div id="category" class="mb-3">
                <label for="categorySelect" class="form-label">카테고리</label>
                <select id="categorySelect" class="form-select" v-model="storeObj.excersiceId" required>
                    <option value="none" disabled selected hidden>--구분--</option>
            ...
            <div id="regist-body" class="mb-4">
                ...
                <input type="text" id="storeAddress" class="form-control" v-model="storeObj.address" required>
                </div>
                <div class="mb-3">
                <label for="phoneNumber" class="form-label">전화번호</label>
                <small class="text-muted d-block mb-2">Format: 123-456-7890</small>
                <input type="text" id="phoneNumber" class="form-control" v-model="storeObj.phoneNumber" required>
                </div>
                <div class="mb-3">
                <label for="openingHours" class="form-label">영업시간</label>
                <small class="text-muted d-block mb-2">Format: 9:00 AM - 8:00 PM</small>
                <input type="text" id="openingHours" class="form-control" v-model="storeObj.openingHours" required>
                </div>
            </div>
...
const registStore = ()=>  {
  store.registStore(storeObj.value, file.value);
};
</script>
